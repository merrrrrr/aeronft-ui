...
export default function SearchResultPage() {
  ...
  const handleSelectReturnFlight = (flightId: number) => {
    router.push('/booking_information');
  };
    ...
    <div className="px-60 pt-6">
      ...
      <div className="bg-gray-700 p-4 rounded-lg shadow-lg flex justify-between items-center">
        <div className="flex flex-col ">
          <h1 className="text-2xl font-bold">Returning Flight</h1>
          <div>From: Tokyo Haneda Airport (HND)</div>
          <div>To: Penang International Airport (PEN)</div>
          <div>Date: 15 March, 2025</div>
        </div>
          ...
          {flights.map((flight) => (
            ...
            >
              ...
              <div className="text-right">
                ...
                <button
                  onClick={() => handleSelectReturnFlight(flight.id)}
